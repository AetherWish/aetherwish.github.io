...
> 内容更新日期：2025年10月30日（于Windows 11）
...
桌面环境：无，可自行安装
最新版本： **25.09** （2025年3月）| 24.03 LTS SP2 | 24.03 LTS SP1
...
支持架构：x86_64/ARM64
桌面环境：DDE（X11/Treeland）
最新版本：**25.0.1** （2025年7月2日）
...
官方网站：<https://www.chinaredflag.cn/> ~~（原<https://www.linuxsir.cn>重新演变为社区）~~
...
支持架构：多架构，需自行编译
桌面环境：openHarmony
最新版本：**6.0 Release/API Level 20** （2025年9月23日）
官方网站：<https://www.openharmony.cn/>
基本介绍及鸿蒙相关说明：

- HarmonyOS：提供部分openHarmony特性与HMS的Android固件包。
- HarmonyOS NEXT：鸿蒙星河版，面向消费者设备与开发者的“纯血鸿蒙”。
...
桌面环境：未知
最新版本：**23.3 GA**（2025年6月30日） | 8.10GA （2025年4月16日）
...
桌面环境：UKUI
最新版本：**2.0 SP2** （2025年8月26日/2025年9月9日）
官方网站：<https://openkylin.top>
基本介绍：宣传“中国首个桌面操作系统根社区”，其桌面环境自首个公开发行版本起即支持Wayland协议；2.0引入“不可变操作系统”特性；提供部分开源的安卓轻量虚拟机KMRE，被[GXDE OS](#gxde-os)移植到多个发行版。
...
基本介绍：NOI系列比赛和CSP-J/S等活动的标准环境，基于Ubuntu 20.04。
...
最新版本：**5.0 with Kernel 6.6** （早于2025年9月12日）
官网仅提供产品介绍，需要其他信息来源
...
基于发行版：Debian
桌面环境：KDE Plasma
最新版本：?.?.? with Kernel 6.14.10（2025年6月14日）
基本介绍：内建由该社区开发的 APT 软件包管理界面“小熊猫包管理 (oma)"，可通用于多个内建 APT 包管理的发行版。

### GXDE OS

主导方：gfdgd_xi/神末shenmo
官方网站：<https://www.gxde.top/>
基于发行版：Debian
桌面环境：GXDE/DDE KWin 15
最新版本：**15.15.3**（2025年9月23日）| 25.2.1（2025年10月1日）
基本介绍：该团队接手维护了Deepin 15.x版本采用的DDE KWin桌面环境，内置星火应用商店与Wine运行器，并借由KMRE实现了安卓应用支持。依托星火应用商店社区建立。
...
2021年1月28日初版于 Deepin 20（哔哩哔哩创作中心） | 2025年5月10日重启更新于 Debian trixie/sid（GitHub Pages）
